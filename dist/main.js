...
let actionMap = {
    ...
    create: {
        ...
        usages: [// 使用方法
        'hc-web-cli create ProjectName', 'hc-cli create ProjectName', 'hcc create ProjectName'],
        alias: 'c' // 命令简称
    },
    // 项目初始化
    init: {
        description: '初始化项目',
        usages: ['hc-web-cli init', 'hc-cli init', 'hcc init'],
        alias: 'i'
    },
    // 启动项目
    dev: {
        description: '本地启动项目',
        usages: ['hc-web-cli dev', 'hc-cli dev', 'hcc dev'],
        options: [{
            flags: '-p --port <port>',
            description: '端口',
            defaultValue: 3000
    ...
    build: {
        description: '服务端项目打包',
        usages: ['hc-web-cli build', 'hc-cli build', 'hcc build'],
        options: [{
